...
<!DOCTYPE html>
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-dark" data-assets-path="../assets/" data-template="vertical-menu-template-free">
...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/sneatadmin/src/assets/vendors/css/demo.css') ?>" />
    ...
    <!-- Helpers -->
    <script src="<?= base_url('assets/sneatadmin/src/assets/vendors/js/helpers.js') ?>"></script>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">Arsip</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item ">
                        <a href="<?= site_url('/chart') ?>" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-chart"></i>
                            <div data-i18n="Analytics">Grafik Chart</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-header small text-uppercase">
                        <span class="menu-header-text">Data Arsip</span>
                    </li>

                    <li class="menu-item">
                        <a href="<?= site_url('/home/search') ?>" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-archive"></i>
                            <div data-i18n="Boxicons">Semua Data</div>
                        </a>
                    </li>
                    <?php if (isset($_SESSION['akses_modul']['entridata']) && $_SESSION['akses_modul']['entridata'] == 'on') {
                        echo '<li class="menu-item"> <a href="' . site_url('/admin/entr') . '" class="menu-link"><i class="menu-icon tf-icons bx bx-archive-in"></i><div data-i18n="Boxicons">Entri Baru</div></a></li>';
                    } ?>
                    <?php if (isset($_SESSION['akses_modul']['sirkulasi']) && $_SESSION['akses_modul']['sirkulasi'] == 'on') {
                        echo '<li class="menu-item"> <a href="' . site_url('/sirkulasi') . '" class="menu-link"><i class="menu-icon tf-icons bx bx-archive-out"></i><div data-i18n="Boxicons">Sirkulasi Arsip</div></a></li>';
                    } ?>
                    ...
                    if ($_SESSION['menu_master']) {
                        ...
                        echo '
                        <li class="menu-header small text-uppercase"><span class="menu-header-text">Menu Master</span></li>
                        <li class="menu-item">
                        ...
                        if (isset($_SESSION['akses_modul']['user']) && $_SESSION['akses_modul']['user'] == 'on') {
                            echo '<li class="menu-item"><a href="' . site_url('admin/vuser') . '" class="menu-link"><div data-i18n="Basic Inputs">Pengguna</div></a></li>';
                        }
                        if (isset($_SESSION['akses_modul']['klasifikasi']) && $_SESSION['akses_modul']['klasifikasi'] == 'on') {
                            echo '<li class="menu-item">
                                <a href="' . site_url('admin/klas') . '" class="menu-link">
                                    <div data-i18n="Basic Inputs">Klasifikasi</div>
                                </a>
                            </li>';
                        }
                        if (isset($_SESSION['akses_modul']['pencipta']) && $_SESSION['akses_modul']['pencipta'] == 'on') {
                            echo '<li class="menu-item">
                                <a href="' . site_url('admin/penc') . '" class="menu-link">
                                    <div data-i18n="Basic Inputs">Pencipta Arsip</div>
                                </a>
                            </li>';
                        }
                        if (isset($_SESSION['akses_modul']['pengolah']) && $_SESSION['akses_modul']['pengolah'] == 'on') {
                            echo '<li class="menu-item">
                                <a href="' . site_url('admin/pengolah') . '" class="menu-link">
                                    <div data-i18n="Basic Inputs">Unit Pengolah</div>
                                </a>
                            </li>';
                        }
                        if (isset($_SESSION['akses_modul']['lokasi']) && $_SESSION['akses_modul']['lokasi'] == 'on') {
                            echo '<li class="menu-item">
                                <a href="' . site_url('admin/lokasi') . '" class="menu-link">
                                    <div data-i18n="Basic Inputs">Lokasi</div>
                                </a>
                            </li>';
                        }
                        if (isset($_SESSION['akses_modul']['media']) && $_SESSION['akses_modul']['media'] == 'on') {
                            echo '<li class="menu-item">
                                <a href="' . site_url('admin/media') . '" class="menu-link">
                                    <div data-i18n="Basic Inputs">Media</div>
                                </a>
                            </li>';
                        }
                        echo "</ul>
