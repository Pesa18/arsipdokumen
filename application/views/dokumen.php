					...
					<div class="row">
						...
						<div class="col-md-4 mb-3">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<select class="form-select" name="retensi" id="retensi">
					...
					<div class="row">
						<div class="col-md-4 mb-3">
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<input id="tanggalCari" name="tanggal" class="form-control input-md" type="text" value="<?php echo $src['tanggal'] ?>">
								</div>
							</div>
						</div>
		...
		const table = $('#data-grid').dxDataGrid({
			...
			toolbar: {
				items: [
					...
					{
						location: "before",
						template: '<div class="quick-links" data-toggle="tooltip" data-placement="top" title="Tambah Arsip"><a href="<?= site_url('/admin/entr'); ?>" role="button" aria-expanded="false" aria-controls="advanced-search" class="nav-link btn btn-primary btn-sm mr-2"><i class="bx bx-folder-plus"></i> Entri Baru</a></div>',
					},
					{
						location: "before",
						template: '<div class="quick-links" id="cariLanjut" data-toggle="tooltip" data-placement="top" title="Pencarian Lanjut"><a href="#" role="button" aria-expanded="false" aria-controls="advanced-search" class="nav-link btn btn-success btn-sm mr-2"><i class="bx bx-search"></i>Pencarian Lanjut</a></div>',
						onClick() {
